...
class NotificationAdmin(admin.ModelAdmin):
    ...
    def piece_title(self, obj):
        """
        Display the title of the piece, or '-' if no piece is associated (for 'follow' interaction).
        """
    ...
    def save_model(self, request, obj, form, change):
        """
        Custom save logic if needed. Currently, just using the parent save method.
        """
